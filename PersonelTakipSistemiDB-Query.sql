...
('LBL_IZINDEKI_PERSONEL', 'tr-TR', 'Ýzindeki Personel'),
('LBL_IZINDEKI_PERSONEL', 'en-US', 'On Leave'),
('LBL_ORTALAMA_MAAS', 'tr-TR', 'Ortalama Maaþ'),
('LBL_ORTALAMA_MAAS', 'en-US', 'Avg. Salary'),
('LBL_DEPARTMAN_DAGILIMI', 'tr-TR', 'Departman Daðýlýmý'),
...
insert into dil_cevirileri (anahtar, dil_kodu, deger) values 
('LBL_AYARLAR_BASLIK', 'tr-TR', 'Sistem Ayarlarý'),
...
('MSG_AYAR_KAYDEDILDI', 'tr-TR', 'Ayarlar baþarýyla kaydedildi. Deðiþikliklerin aktif olmasý için program yeniden baþlatýlacak.'),
('MSG_AYAR_KAYDEDILDI', 'en-US', 'Settings saved successfully. The application will restart to apply changes.')

-- Genel Butonlar
insert into dil_cevirileri (anahtar, dil_kodu, deger) values 
('BTN_IPTAL', 'tr-TR', 'Ýptal'),
...
('LBL_KULLANICI_ADI', 'tr-TR', 'Kullanýcý Adý'),
('LBL_KULLANICI_ADI', 'en-US', 'Username'),
('LBL_SIFRE', 'tr-TR', 'Þifre'),
('LBL_SIFRE', 'en-US', 'Password'),
('BTN_GIRIS_YAP', 'tr-TR', 'GÝRÝÞ YAP'),
('BTN_GIRIS_YAP', 'en-US', 'LOGIN'),
('MSG_GIRIS_BASARILI', 'tr-TR', 'Hoþgeldiniz'),
('MSG_GIRIS_BASARILI', 'en-US', 'Welcome'),
('MSG_HATALI_GIRIS', 'tr-TR', 'Hatalý kullanýcý adý veya þifre!'),
('MSG_HATALI_GIRIS', 'en-US', 'Invalid username or password!'),
('MSG_BOS_ALAN', 'tr-TR', 'Lütfen kullanýcý adý ve þifre giriniz.'),
...
('COL_ISE_GIRIS', 'tr-TR', 'Ýþe Giriþ Tarihi'),
...
('MSG_SILME_ONAY', 'tr-TR', 'Seçili personeli silmek istediðinize emin misiniz?'),
('MSG_SILME_ONAY', 'en-US', 'Are you sure you want to delete the selected employee?');


insert into dil_cevirileri (anahtar, dil_kodu, deger) values 
('LBL_PERSONEL_ISLEM_BASLIK', 'tr-TR', 'Personel Ýþlemleri'),
...
('MSG_KAYIT_BASARILI', 'tr-TR', 'Personel kaydý baþarýyla tamamlandý.'),
('MSG_KAYIT_BASARILI', 'en-US', 'Personnel record saved successfully.');

insert into dil_cevirileri (anahtar, dil_kodu, deger) values 
('LBL_IZIN_LISTESI_BASLIK', 'tr-TR', 'Ýzin Hareketleri ve Onay'),
('LBL_IZIN_LISTESI_BASLIK', 'en-US', 'Leave Requests & Approval'),
('LBL_IZIN_ISTEGI_BASLIK', 'tr-TR', 'Yeni Ýzin Talebi'),
('LBL_IZIN_ISTEGI_BASLIK', 'en-US', 'New Leave Request'),
('COL_IZIN_TURU', 'tr-TR', 'Ýzin Türü'),
('COL_IZIN_TURU', 'en-US', 'Leave Type'),
('COL_BASLANGIC', 'tr-TR', 'Baþlangýç'),
('COL_BASLANGIC', 'en-US', 'Start Date'),
('COL_BITIS', 'tr-TR', 'Bitiþ'),
...
('BTN_YENI_IZIN', 'tr-TR', 'Ýzin Ýste'),
('BTN_YENI_IZIN', 'en-US', 'Request Leave'),
('LBL_ACIKLAMA', 'tr-TR', 'Açýklama'),
('LBL_ACIKLAMA', 'en-US', 'Description'),
('MSG_TARIH_HATA', 'tr-TR', 'Bitiþ tarihi baþlangýç tarihinden küçük olamaz.'),
('MSG_TARIH_HATA', 'en-US', 'End date cannot be earlier than start date.'),
('MSG_ISLEM_BASARILI', 'tr-TR', 'Ýþlem baþarýyla gerçekleþti.'),
('MSG_ISLEM_BASARILI', 'en-US', 'Operation completed successfully.');

insert into dil_cevirileri (anahtar, dil_kodu, deger) values 
('LBL_MAAS_LISTESI_BASLIK', 'tr-TR', 'Maaþ ve Ödeme Geçmiþi'),
('LBL_MAAS_LISTESI_BASLIK', 'en-US', 'Salary & Payment History'),
('LBL_MAAS_ODEME_BASLIK', 'tr-TR', 'Maaþ Ödeme Ekraný'),
...
('LBL_DONEM', 'tr-TR', 'Dönem (Ay/Yýl)'),
('LBL_DONEM', 'en-US', 'Period (Month/Year)'),
('LBL_ANA_MAAS', 'tr-TR', 'Ana Maaþ'),
...
('MSG_ODEME_VAR', 'tr-TR', 'Bu personele seçilen dönem için zaten ödeme yapýlmýþ.'),
...
-- 2024 Yýlý Verileri (Gecmis Donem)

-- 1. CEO (Ahmet Yilmaz) - Düzenli maaþ + Yýl sonu primi
...
(1, 2024, 3, 85000, 5000, 0, 90000, '2024-03-31', 1), -- Prim almýs
...
-- 8. Satýþ Temsilcisi (Merve Acar) - Satýþ Primi
insert into maas_bordro (personel_id, yil, ay, brut_maas, primler, kesintiler, net_odenen, odeme_tarihi, durum) values 
(8, 2024, 1, 30000, 15000, 0, 45000, '2024-01-31', 1), -- Yüksek prim
(8, 2024, 2, 30000, 12000, 0, 42000, '2024-02-28', 1);

-- 2025 Yýlý (Güncel Dönem - Henüz ödenmemiþ veya yeni ödenmiþ)
insert into maas_bordro (personel_id, yil, ay, brut_maas, primler, kesintiler, net_odenen, odeme_tarihi, durum) values 
(1, 2025, 1, 100000, 0, 0, 100000, '2025-01-31', 1), -- Zamlý maaþ
...
('BTN_RAPOR_GORUNTULE', 'tr-TR', 'Raporu Oluþtur'),
...
('COL_TOPLAM_MAAS', 'tr-TR', 'Toplam Maaþ Yükü'),
('COL_TOPLAM_MAAS', 'en-US', 'Total Salary Cost'),
('COL_ORTALAMA_MAAS', 'tr-TR', 'Ortalama Maaþ'),
('COL_ORTALAMA_MAAS', 'en-US', 'Avg. Salary'),
('LBL_MAAS_RAPOR_BASLIK', 'tr-TR', 'Departman Bazlý Maliyet Analizi'),
('LBL_MAAS_RAPOR_BASLIK', 'en-US', 'Department Cost Analysis'),
('LBL_IZIN_RAPOR_BASLIK', 'tr-TR', 'Personel Ýzin Hareketleri Raporu'),
...
('BTN_EK_MESAI', 'tr-TR', 'Ek Mesai Giriþi'),
...
('LBL_MESAI_BASLANGIC', 'tr-TR', 'Mesai Baþlangýç'),
('LBL_MESAI_BASLANGIC', 'en-US', 'Overtime Start'),
('LBL_MESAI_BITIS', 'tr-TR', 'Mesai Bitiþ'),
